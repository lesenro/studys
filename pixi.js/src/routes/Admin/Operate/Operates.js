...
import { OperateHelper,OperateSetting } from './OperateSetting';
...
@Form.create()
export default class Operates extends PureComponent {
  state = {
    modalVisible: false,
    expandForm: false,
    selectedRows: [],
  ...
  render() {
    ...
    return (
      <PageHeaderLayout>
        ...
        <OperateEdit modalVisible={modalVisible} onSubmit={ev=>{
